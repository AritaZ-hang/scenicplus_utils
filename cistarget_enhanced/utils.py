...
def load_motif_annotations(specie: str,
    ...
    ---------
    2023/03/27 Adapted by Shuang Zhang
    add support to potential NAN values.
    """
    ...
    ## however we usually provide a brand new .tbl file.
    ...
    df_direct_annot['TF'] = df_direct_annot['TF'].fillna('')
    ...
    motif_similarity_annot['TF'] = motif_similarity_annot['TF'].fillna('')
    ...
    orthology_annot['TF'] = orthology_annot['TF'].fillna('')
    ...
    motif_similarity_and_orthology_annot['TF'] = motif_similarity_and_orthology_annot['TF'].fillna('')
    ...
    df['Direct_annot'] = df['Direct_annot'].fillna('')
    df['Motif_similarity_annot'] = df['Motif_similarity_annot'].fillna('')
    df['Orthology_annot'] = df['Orthology_annot'].fillna('')
    df['Motif_similarity_and_Orthology_annot'] = df['Motif_similarity_and_Orthology_annot'].fillna('')
    return df
