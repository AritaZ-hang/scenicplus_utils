...
def run_scenicplus(scplus_obj: 'SCENICPLUS',
    ...
    **kwargs
    ...
    species: str
        Species from which data comes from. Possible values: 'hsapiens', 'mmusculus', 'dmelanogaster'... Please make sure your input is in ensembl format.
    ensembl_assembly: str
